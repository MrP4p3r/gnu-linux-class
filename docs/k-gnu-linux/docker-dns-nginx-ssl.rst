...
.. image:: ../_static/img/k-gnu-linux/edit-zone.png
...
.. image:: ../_static/img/k-gnu-linux/dig-dig.png
...
Материалы для дополнительного ознакомления:
    ...
    1. `Справка по PowerDNS <https://doc.powerdns.com/authoritative/index.html>`_
    2. `Справка (репозиторий) по acme.sh <https://github.com/Neilpang/acme.sh>`_

Ссылки на репозитории с результатами работы:

    1. `Разработанный контейнер dns-nginx-ssl <https://suai-gogs.hlebushe.gq/MrP4p3r/dns-nginx-ssl>`_
    2. `Контейнер обратный прокси на документацию <https://github.com/MrP4p3r/rtd-reverse-proxy>`_
